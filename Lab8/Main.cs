...
namespace Lab8
{
    sealed class MAGAZUN_FUNCTIONS
    {
        ...
        public void find_reguarded()
        {
            foreach(string product in client.List_of_buy)
            {
                ...
                else Console.WriteLine("Product " + product + " found"!);
            }
        ...
        public void load_list()
        {
            ...
            while(File.Exists(@"D:\Pete's\Studying\Labs\Lab8\Product" + i + ".txt"))
            {
                tmp = new ITEM();

                tmp.code.download(@"D:\Pete's\Studying\Labs\Lab8\Product" + i + ".txt");
        ...
        public void create_gift()
        {
            ...
            foreach(ITEM tmp in All_Items)
            {
                ...
                else if(oper == "No" || oper == "NO" || oper == "no")
                    {
                        choise = false;
                    }
                else
        ...
        public int Admin_menu()
        {
            ...
            Console.WriteLine("4 - Reopen casa;");
            Console.WriteLine("5 - Close shop;");
